...
1. **Sales Dashboard**: Tracks revenue performance, profitability, and product trends
2. **Customer Dashboard**: Monitors customer acquisition, behavior, and engagement patterns
...
- **KPI Overview**: Year-over-year comparison of total sales, profit, and quantity.
- **Monthly Trends**: Monthly performance for sales, profit, and quantity with clear highest/lowest month highlights.
- **Subcategory Insights**: Sales and profit comparison across product subcategories for current vs previous year.
- **Weekly Analysis**: Weekly sales & profit trends, average benchmarks, and highlight of above/below-average weeks.
...
### 🔑 Key Features & Requirements
- **KPI Overview**: Year-over-year view of total customers, total orders, and sales per customer.
- **Monthly Customer Trends**: Monthly patterns for customers, orders, and sales with highest/lowest month indicators.
- **Order Distribution**: Customer distribution based on number of orders to understand engagement and loyalty.
- **Top Customers**: Top 10 customers by profit with rank, orders, sales, profit, and last order date.
